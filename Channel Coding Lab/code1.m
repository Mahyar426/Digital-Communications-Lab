...
[output,N,RATIO(1,SS-SNRmin+1)]=My_modem(coded_stream,Fc,Tsym,Ts,'PSK',2,SS);
...
BER1(1,SS-SNRmin+1)=Sum/(numel(BiT_stream_out));
%BER2(1,SS-SNRmin+1)=(biterr(BiT_stream_out,BiT_stream_in))/1000;
end
figure;
plot((SNRmin:SNRmax),BER1);